...
namespace UrlShortener.Migrations
{
    public partial class InitialCommit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UrlId = table.Column<int>(type: "int", nullable: false),
                    UrlDataUrlId = table.Column<int>(type: "int", nullable: true),
                    CreatedOn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeletedItems_UrlDatas_UrlDataUrlId",
                        column: x => x.UrlDataUrlId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeletedItems_UrlDataUrlId",
                table: "DeletedItems",
                column: "UrlDataUrlId");
